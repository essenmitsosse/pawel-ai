define( [
	...
	keyboardHandler.addKeyboardShortcut( {
		key: 32
	}, timerController.toggleAllTimeouts );

	// noAnimation 'CTRL A'
	keyboardHandler.addKeyboardShortcut( {
		key: 65,
		ctrl: true,
	}, globalSetter.getGlobalToggler( "noAnimation" ) );

	// noScroll 'CTRL S'
	keyboardHandler.addKeyboardShortcut( {
		key: 83,
		ctrl: true,
	}, globalSetter.getGlobalToggler( "allowScroll" ) );

	// debug 'CTRL + G'
	keyboardHandler.addKeyboardShortcut( {
		key: 71,
		ctrl: true,
	}, globalSetter.getGlobalToggler( "grid" ) );
	...
	keyboardHandler.addKeyboardShortcut( {
		...
		ctrl: true,
		shift: true
	}, globalSetter.getGlobalToggler( "superGrid" ) );
} );
